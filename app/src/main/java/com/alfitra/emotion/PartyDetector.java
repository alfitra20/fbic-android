...
public class PartyDetector extends AppCompatActivity  implements Detector.FaceListener, Detector.ImageListener, CameraDetector.CameraEventListener,
    ...
    private boolean multiFaceModeEnabled = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_detector);
        initializeUI();
    ...
    void initializeCameraDetector() {
        ...
        // detector.setLicensePath("/app/src/main/assets/Affdex/license.txt");
