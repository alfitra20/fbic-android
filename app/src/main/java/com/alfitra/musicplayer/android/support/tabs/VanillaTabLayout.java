...
package com.alfitra.musicplayer.android.support.tabs;
...
public class VanillaTabLayout extends SlidingTabLayout {
	...
	public VanillaTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		setSelectedIndicatorColors(context.getResources().getColor(com.alfitra.heartfeels.R.color.tabs_active_indicator));
	...
	protected TextView createDefaultTabView(Context context) {
		...
		view.setTextColor(getResources().getColorStateList(com.alfitra.heartfeels.R.color.tab_text_selector));
		view.setBackgroundResource(com.alfitra.heartfeels.R.drawable.unbound_ripple_light);
		view.setMaxLines(1);
